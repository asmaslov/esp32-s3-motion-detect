...
# Edge Impulse library for industrial-motion-classifier

This is a C++ library that lets you run the impulse for "industrial-motion-classifier" (http://localhost:4800/studio/201134) on any device. It consists of the Edge Impulse inferencing SDK - with implementations of both processing and learning blocks - and your model. You will need to include this library in your project to run your impulse locally.
